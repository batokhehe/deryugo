...
class CMSAnchoringContent6Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('layouts.admin.pages.cms.anchoring_content6.index')
                ->with('datas', $data);
    }
    ...
    public function show($id)
    {
        ...
        $cms_anchoring_image_tiles = CmsAnchoringImageTile::where('cms_anchoring_id', $cms_anchorings->id)->where('content', '6')->first();
        ...
        return view('layouts.admin.pages.cms.anchoring_content6.detail')
    ...
    public function edit($id)
    {
        ...
        return view('layouts.admin.pages.cms.anchoring_content6.edit')
                ->with('cms_anchorings', $cms_anchorings)
                ->with('cms_anchoring_image_tiles', $cms_anchoring_image_tiles)
                ->with('cms_anchoring_image_tile_details', $cms_anchoring_image_tile_details);
    }
    ...
    {
        //CONTENT 6
        $image_tile_old = CmsAnchoringImageTile::select('id')->where('cms_anchoring_id', $id)->where('content', '6')->first();
        if($image_tile_old){
            $data = array(
                'title' => $request->post('image_tile_title'),
            );
            CmsAnchoringImageTile::where('cms_anchoring_id', $id)->where('content', '6')->update($data);
        ...
        return redirect()->route('admin.cms.anchoring_content6')->with('success', 'Data Added');
    }
