...
class CMSHomeContent3Controller extends Controller
{
    /**
    ...
    public function index()
    {
        //
        $data = CmsHome::all();
        return view('layouts.admin.pages.cms.home_content3.index')
                ->with('datas', $data);
    }
    ...
    {
        //
        return view('layouts.admin.pages.cms.home_content3.create');
    }
    ...
    public function show($id)
    {
        ...
        $cms_homes_images_contents = CmsHomesImagesContent::where('cms_homes_id', $cms_homes->id)->where('content', '3')->first();
        ...
        return view('layouts.admin.pages.cms.home_content3.detail')
    ...
    public function edit($id)
    {
        ...
        return view('layouts.admin.pages.cms.home_content3.edit')
                ->with('cms_homes', $cms_homes)
                ->with('cms_homes_images_contents', $cms_homes_images_contents)
                ->with('cms_homes_images_contents_details', $cms_homes_images_contents_details);
    }
    ...
    {
        //CONTENT 3
        $home_image_content_old = CmsHomesImagesContent::select('id')->where('cms_homes_id', $id)->where('content', '3')->first();
        if($home_image_content_old){
            $data = array(
                'title' => $request->post('image_content_title'),
                'desc' => $request->post('image_content_description'),
            );
            $home_content1_content = CmsHomesImagesContent::where('cms_homes_id', $id)->where('content', '3')->update($data);
        ...
        return redirect()->route('admin.cms.home_content3')->with('success', 'Data Added');
    }
