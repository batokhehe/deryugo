...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ url('/brand/tools') }}" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php
        $brand_id = \App\Brand::where('user_id', Auth::user()->id)->first()->id;
      ?>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown tasks-menu">
            <a href="{{ url('/') }}#" class="dropdown-toggle" data-toggle="dropdown" id="notifications">
              ...
              <span class="label label-warning" id="notificationsCount">{{ getCampaignNotificationCountBrand($brand_id) }}</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have {{ getCampaignNotificationCountBrand($brand_id) }} Notifications</li>
              <li>
                <ul class="menu">
                  <!-- inner menu: contains the actual data -->
                  <?php
                    $campaigns = getCampaignNotificationListBrand($brand_id);
                    ...
                    foreach ($campaigns as $campaign) { ?>
                      ...
                      ?>
                      <li>
                        <a href="{{ route('brand.campaign.detail', ['id' => $campaign->campaign_id]) }}">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li><a href="{{ url('/brand/tools') }}"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;">
            <li><a href="{{ url('/brand/tools/newcampaign') }}"><i class="fa fa-circle-o"></i> New Campaign</a></li>
            <li><a href="{{ url('/brand/tools/mycampaign') }}"><i class="fa fa-circle-o"></i> My Campaign</a></li>
          </ul>
        </li>
...
<script type="text/javascript">
  $("#notifications").click(function (e) {
      ...
      $.ajax({
        url: "{{ route('notifications.brand.read') }}",
