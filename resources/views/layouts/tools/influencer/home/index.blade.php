...
<div class="content-wrapper">
  ...
  <!-- TO DO List -->
    ...
    <div class="row">
        ...
        <div class="box" style="border-top-color:#D33724">
          <div class="box-header with-border">
            <h3 class="box-title">Growth of Total Followers</h3>
          ...
          <div class="box-body">
            <div class="chart">
              <!-- <canvas id="barChart3" style="height:230px" data-toggle="modal" data-target="#modal-default"></canvas> -->
                    <canvas id="lineChartFollowers" style="height:230px"></canvas>
            </div>
          </div>
          <!-- /.box-body -->
        ...
        <div class="box" style="border-top-color:#D33724">
          <div class="box-header with-border">
            <h3 class="box-title">Post Engagement Rate</h3>
            <div class="box-tools pull-right">
              <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
              </button>
              <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          ...
          <div class="box-body">
            <div class="chart">
              <!-- <canvas id="barChart3" style="height:230px" data-toggle="modal" data-target="#modal-default"></canvas> -->
                    <canvas id="lineChartPostER" style="height:230px"></canvas>
            </div>
          </div>
          <!-- /.box-body -->
          <div class="box-footer">
        ...
        <div class="box" style="border-top-color:#D33724">
          <div class="box-header with-border">
            <h3 class="box-title">Profile Engagement Rate</h3>
            <div class="box-tools pull-right">
              <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
              </button>
              <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
          ...
          <div class="box-body">
            <div class="chart">
              <!-- <canvas id="barChart3" style="height:230px" data-toggle="modal" data-target="#modal-default"></canvas> -->
                    <canvas id="lineChartProfileER" style="height:230px"></canvas>
            </div>
          </div>
          <!-- /.box-body -->
          <div class="box-footer">
...
@section('scripts')
@include('layouts.tools.influencer.home.scripts')
@endsection
