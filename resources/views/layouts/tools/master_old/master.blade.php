      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;">
            <li><a href="{{ url('/tools/newcampaign') }}"><i class="fa fa-circle-o"></i> New Campaign</a></li>
            <li><a href="{{ url('/tools/mycampaign') }}"><i class="fa fa-circle-o"></i> My Campaign</a></li>
          </ul>
        </li>
        <li><a href="{{ url('/tools/socmed') }}"><i class="fa fa-dashboard"></i> <span>Social Media</span></a></li>
        <li><a href="{{ url('/tools/messages') }}"><i class="fa fa-envelope"></i> <span>Messages</span></a></li>
        <li><a href="{{ url('/tools/payment') }}"><i class="fa fa-dollar"></i> <span>Payment</span></a></li>
        <li><a href="{{ url('/tools/calendar') }}"><i class="fa fa-calendar"></i> <span>Calendar</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
