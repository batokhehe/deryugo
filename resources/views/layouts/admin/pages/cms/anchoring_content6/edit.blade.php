...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" action="{{ route('admin.cms.anchoring_content6.update', ['id' => $cms_anchorings->id]) }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            @if(count($errors) > 0)
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="image_tile_title" placeholder="Content 6 Title" value="{{ $cms_anchoring_image_tiles ? $cms_anchoring_image_tiles->title : '' }}">
                        </div>
                    </div>
                    <a id="add-image-tile-detail" class="btn btn-primary pull-right" style="margin-bottom: 10px"><i class="fa fa-plus"></i> &nbsp;Add More Content 6 Detail</a>
                            ...
                            @if(count($cms_anchoring_image_tile_details) > 0)
                                ...
                                <tr>
                                    <td> 
                                        ...
                                        <img class="image-tile-detail-preview" src="{{ url('/assets/images/anchoring_image_tile/' . $cms_anchoring_image_tiles_detail->image) }}" alt="Content 6 Detail Image Preview" width="30%" />
                                    </td>
                            ...
                            @else
                                <tr>
                                    <td>
                                        ...
                                        <img class="image-tile-detail-preview" src="#" alt="Content 6 Detail Image Preview" width="30%" />
                                    </td>
                                    <td><a class="btn btn-sm btn-danger delete-image-tile-detail"><i class="fa fa-trash-o"></i></a></td>
                                </tr>
                            @endif
...
@endsection
@section('script')
@include('layouts.admin.pages.cms.anchoring_content6.script')
@endsection
