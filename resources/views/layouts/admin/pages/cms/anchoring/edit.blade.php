...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" action="{{ route('admin.cms.home.edit', ['id' => $cms_homes->id]) }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            @if(count($errors) > 0)
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <img class="content-detail-preview" src="{{ url('/assets/images/image_content/' . $cms_homes_images_contents_detail->image) }}" alt="Content 2 Detail Image Preview" width="100%" />
                                </td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <input type="file" class="form-control image-content-detail-image" name="image_content_detail_image3_old[]" accept="image/*">
                                    <img class="content-detail-preview3" src="{{ url('/assets/images/image_content/' . $cms_homes_images_contents_detail3->image) }}" alt="Content 3 Detail Image Preview" width="100%" />
                                </td>
