        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <table width="100%" id="content-table" class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        @php $i = 1; @endphp
                        @foreach ($cms_anchorings_contents_details as $cms_anchorings_contents_detail)
                        <tr>
                            <td> {{ $i }} </td>
                            <td> {{ $cms_anchorings_contents_detail->title }} </td>
                            <td> {{ $cms_anchorings_contents_detail->desc }} </td>
                            <td width="30%"> <img src="{{ url('/assets/images/anchoring_content/' . $cms_anchorings_contents_detail->image) }}" width="100%" /> </td>
                        </tr>
                        @php $i++; @endphp
                        @endforeach
                    </tbody>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <table width="100%" id="image-content-table" class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        @php $i = 1; @endphp
                        @foreach ($cms_anchorings_images_contents_details as $cms_anchorings_images_contents_detail)
                        <tr>
                            <td> {{ $i }} </td>
                            <td> {{ $cms_anchorings_images_contents_detail->name }} </td>
                            <td> {{ $cms_anchorings_images_contents_detail->title }} </td>
                            <td> {{ $cms_anchorings_images_contents_detail->desc }} </td>
                            <td width="30%"> <img src="{{ url('/assets/images/image_content/' . $cms_anchorings_images_contents_detail->image) }}" width="100%" /> </td>
                        </tr>
                        @php $i++; @endphp
                        @endforeach
                    </tbody>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <table width="100%" id="image-content-table3" class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        @php $i = 1; @endphp
                        @foreach ($cms_anchorings_images_contents_details3 as $cms_anchorings_images_contents_detail3)
                        <tr>
                            <td> {{ $i }} </td>
                            <td> {{ $cms_anchorings_images_contents_detail3->name }} </td>
                            <td> {{ $cms_anchorings_images_contents_detail3->title }} </td>
                            <td> {{ $cms_anchorings_images_contents_detail3->desc }} </td>
                            <td width="30%"> <img src="{{ url('/assets/images/image_content/' . $cms_anchorings_images_contents_detail3->image) }}" width="100%" /> </td>
                        </tr>
                        @php $i++; @endphp
                        @endforeach
                    </tbody>
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <p>{{ $cms_anchorings_text_contents->desc }}</p>
                    </div>
                </div>
            </div>  
            <!-- /.box-body -->
