                ...
                <div class="box-body">
                    ...
                    <table width="100%" id="image-tile-table" class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $i }}</td>
                                <td><img class="image-tile-detail-preview" src="{{ url('/assets/images/anchoring_image_tile/' . $cms_anchoring_image_tiles_detail->image) }}" alt="Content 7 Detail Image Preview" width="30%" /></td>
                            </tr>
                            @php $i++ @endphp
                            @endforeach
                        </tbody>
