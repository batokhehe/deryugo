...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" action="{{ route('admin.cms.home_content2.update', ['id' => $cms_homes->id]) }}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            @if(count($errors) > 0)
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="image_content_title" placeholder="Content 2 Title" value="{{ $cms_homes_images_contents ? $cms_homes_images_contents->title : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="image_content_description" class="control-label">Content 2 Description</label>
                            <textarea class="form-control" name="image_content_description" placeholder="Content 2 Description">{{ $cms_homes_images_contents ? $cms_homes_images_contents->desc : '' }}</textarea>
                        </div>
                    </div>
